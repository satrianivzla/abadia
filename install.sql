-- --------------------------------------------------------
-- Abadia Sales App - Full Installation SQL
-- --------------------------------------------------------
-- This file contains the complete schema for the application.
-- Execute this script on an empty database to install all tables.
-- Order of execution:
-- 1. Ion Auth tables (groups, users, etc.)
-- 2. Agentes lookup tables (cargos, estados, etc.)
-- 3. Agentes main table
-- 4. Personas table (for affiliations)
-- 5. Afiliaciones main table
-- 6. Afiliacion_Familiares pivot table
-- 7. Soft delete migration for agentes table
-- --------------------------------------------------------


--
-- Part 1: Ion Auth Schema
--
